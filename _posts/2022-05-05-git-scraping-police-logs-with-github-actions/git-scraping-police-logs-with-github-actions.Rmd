...
I have become increasingly interested in publicly available data and what such data can provide. 
...
![Figure from Github Repo: https://github.com/nagol/SLOPD_activity](final_time_series.png) 

## Git-Scraping

Git-scraping is a fantastic solution for the automated scraping and storing
of data. The term/conncept was pioneered by [Simon Willson in his article](https://simonwillison.net/2020/Oct/9/git-scraping/). His article is fantastic, short, and easy to follow with plenty of examples.
...
(each of which represents a SLOPD incident), and parses out the data.
