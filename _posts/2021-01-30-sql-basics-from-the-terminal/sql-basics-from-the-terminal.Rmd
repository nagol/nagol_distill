...
To run the script, type `sqlite3 -echo -column -header course.db < query.sql`. The
...
to manually `rm course.db` our database. Databases have built in mechanisms to prevent
