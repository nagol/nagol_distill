---
title: "Ranking of Baseball Teams - A Model Based Approach"
description: |
  Teams play many games over the course of the season but they play teams in their
  division most often. Further, we need to account for situations where say Team A might    lose to Team B and beat Team C, but Team C has also won a game against Team B. How
  can we objectively rank teams where we only focus on who has beaten who?
preview: heatMap.png
author:
  - name: Logan Lossing
    url: {}
...
path_to_data <- "~/Documents/nagol_distill/_posts/2021-01-21-ranking-of-baseball-teams-a-model-based-approach/ymat.csv"
...
Now, is the log-likelihood concave? No, it does not appear to be so. To
see this consider the scenario where one team is particularly bad and
...
Implmentation of Newton's Method
--------------------------------
...
probability of beating any opponent wheras the Boston Red Sox's row is
