...
![Screenshot from an New York Times Daily Wordle Game](wordle_game_screenshot.png)
...
from the passed `english_dictionary` that are found to be impossible given the
...
determined by the inputs. Streamlit makes this easy with Streamlit's *write* method.
...
![Screenshot from the Final Wordle Helper App](wordle_app_screenshot.png)